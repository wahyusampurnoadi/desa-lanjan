...
export default function HeroSection() {
  ...
  return (
    <section id="beranda" className="relative w-full bg-slate-950 text-white transition-colors duration-300 pb-12 md:pb-0">
      ...
      <div className="w-full overflow-hidden" ref={emblaRef}>
        <div className="flex w-full">
          {HERO_SLIDES.map((slide) => (
            <div 
              key={slide.id} 
              className="relative w-full min-w-full flex-shrink-0 flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 pb-16 sm:pb-36 min-h-[580px] sm:min-h-[620px] md:min-h-[calc(100vh-80px)] select-none overflow-hidden"
            >
              {/* Background Image */}
              <div 
      ...
      {/* STAT SECTION: Tersusun rapi di bawah carousel pada Mobile, Melayang pada Desktop */}
